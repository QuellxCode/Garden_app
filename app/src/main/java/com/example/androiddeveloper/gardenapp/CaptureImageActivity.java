        ...
        imgcount.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (h != 99999999) {
                    ...
                    //     StorageReference mountainImagesRef = storageRef.child("images/gardens.jpg");
/*
...
/**/
                    ...
                    uploadTask.addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            DatabaseReference imgref = firebaseDatabase.getReference().child("pendingimages").child("img" + h);

                            Map<String, String> map = new HashMap<>();
                            map.put("imgid", downloadUrl.toString().trim());
                            map.put("status", "pending");
                            map.put("title", "Image Tilte");
                            map.put("dkey", "img" + h);
                            imgref.setValue(map);
                            imgcount.setValue(h);
                            h = 99999999;
